...
##**Coming Soon**
1. Calculating a midpoint between 3+ users.
2. Integrating Google Places API for the most up-to-date establishment information. 
3.  ** We will be adding new features in the future **
